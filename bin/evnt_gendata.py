...
if __name__ == '__main__':
	...
	op.add_option('--avgcncpt', default='none', type='str', dest='avgcncpt', help='indicate whether use average concept embedding')
